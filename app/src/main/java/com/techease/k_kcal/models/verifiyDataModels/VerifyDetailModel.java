...
public class VerifyDetailModel {
    ...
    @Expose
    private Integer accountActivationStatus;
    ...
    public Integer getAccountActivationStatus() {
        return accountActivationStatus;
    }

    public void setAccountActivationStatus(Integer accountActivationStatus) {
