...
public class SocialLoginUserModel {
    @SerializedName("id")
    @Expose
    private Integer id;
    @SerializedName("name")
    ...
    @SerializedName("sinupType")
    @Expose
    private Object sinupType;
    ...
    public Object getSinupType() {
        return sinupType;
    }

    public void setSinupType(Object sinupType) {
        this.sinupType = sinupType;
    }
