...
public class EditProfileFragment extends Fragment {
    ...
    private void initUI() {
        ...
        tvName.setText(GeneralUtills.getName(getActivity()));
        tvEmail.setText(GeneralUtills.getEmail(getActivity()));
    ...
    private void apiCallUserProfileUpdate() {
        ...
        Call<ProfileUpdateResponseModel> userLogin = services.updateProfile(strName, strNumber, strEmail);
